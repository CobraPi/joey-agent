...
```bash
python3 -m pyfiglet "JOEY" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=JOEY&font=Slant" | boxes -d stone
```
