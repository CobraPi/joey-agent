/**
 * Joey desktop plugin template. Save as:
 *   <joey home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <joey home> is ~/.joey by default, or ~/.joey/profiles/<name>
 * when running a named profile (`joey -p <name>`). Run `joey doctor` (or
 ...
 * Only these imports resolve: @joey/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@joey/plugin-sdk'
