...
mod tests {
    ...
    #[test]
    fn team_lead_directive_carries_concurrency_line() {
        let d = team_lead_directive(8, 4);
        assert!(d.contains("Concurrency: keep at most 4 teammates"));
        assert!(d.contains("LEAD"));
        assert!(!d.contains("SPECIALISTS"));
    }
