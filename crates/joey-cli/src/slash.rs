...
pub static REGISTRY: &[CommandDef] = &[
    ...
    cmd!("hypercode", &[], "Parallel task optimization: decompose work into max parallel workstreams with Explorer/Implementor agents", "Session", "[status|configure <explorer|implementor> <provider> <model>]", true),
