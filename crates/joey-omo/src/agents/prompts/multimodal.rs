//! Multimodal-Looker — vision/screenshot analysis specialist.
//! Port of OMO's `omo-opencode/src/agents/multimodal-looker.ts`.

use crate::models::ModelFamily;

/// The default Multimodal-Looker prompt — interprets media files that cannot
/// be read as plain text (PDFs, images, diagrams).
...
/// Select the Multimodal-Looker prompt variant for the given model.
/// Model-agnostic — same identity for all families.
